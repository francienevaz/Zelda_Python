...
class AnimationPlayer:
	def __init__(self):
		self.frames = {
			...
			# leafs 
			'leaf': (
				load_image_assets('../graphics/particles/leaf1'),
				load_image_assets('../graphics/particles/leaf2'),
				load_image_assets('../graphics/particles/leaf3'),
				load_image_assets('../graphics/particles/leaf4'),
				load_image_assets('../graphics/particles/leaf5'),
				load_image_assets('../graphics/particles/leaf6'),
				self.reflect_images(load_image_assets('../graphics/particles/leaf1')),
				self.reflect_images(load_image_assets('../graphics/particles/leaf2')),
				self.reflect_images(load_image_assets('../graphics/particles/leaf3')),
				self.reflect_images(load_image_assets('../graphics/particles/leaf4')),
				self.reflect_images(load_image_assets('../graphics/particles/leaf5')),
				self.reflect_images(load_image_assets('../graphics/particles/leaf6'))
				)
			}
